...
use EzLoc\Bundle\SiteBundle\Entity\Place;
use EzLoc\Bundle\SiteBundle\Form\PlaceType;
...
class PlaceController extends Controller
{
     ...
     * @Method("POST")
     * @Template("EzLocSiteBundle:Place:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EzLocSiteBundle:Place')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EzLocSiteBundle:Place:edit.html.twig")
     */
