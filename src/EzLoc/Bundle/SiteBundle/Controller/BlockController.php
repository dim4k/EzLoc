...
use EzLoc\Bundle\SiteBundle\Entity\Block;
use EzLoc\Bundle\SiteBundle\Form\BlockType;
...
class BlockController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EzLocSiteBundle:Block')->findAll();
     ...
     * @Method("POST")
     * @Template("EzLocSiteBundle:Block:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EzLocSiteBundle:Block')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EzLocSiteBundle:Block:edit.html.twig")
     */
